  ...
  - Apply Hungarian notation and PascalCase to variable and function names (e.g., string - `str_Filename`, integer - `int_Count`, array - `arr_Files`, boolean - `b_MyBoolean`, lists - `lst_SomeList`, function - `fn_MyFunction()`).
  - Avoid using external dependencies unless explicitly asked.
  - Prioritize portability and POSIX compliance.
  - Ask for clarification if the user's intent is ambiguous or if you are unsure about something.
